...
# _C.INPUT.RRCROP_RATIO = (0.75, 1.3333333)
# _C.INPUT.RRCROP_SCALE = (0.8, 1.0)
...
# Segmentation extras
_C.INPUT.CROP_SIZE = (224, 224)      # used by seg_transforms for random crop / resized crop target
_C.INPUT.SCALE_RANGE = (0.5, 2.0)    # only used if you include "random_resize"
...
# --- Segmentation extras (LULC) ---
_C.DATASET.NUM_CLASSES = -1
_C.DATASET.CLASSNAMES = ()
...
# _C.TRAINER.HICROPL = CN()
# _C.TRAINER.HICROPL.N_CTX = 16
# _C.TRAINER.HICROPL.CROSS_LAYER =  6
# _C.TRAINER.HICROPL.CTX_INIT= "a photo of a"
# _C.TRAINER.HICROPL.PREC = "amp"
# _C.TRAINER.HICROPL.PROMPT_DEPTH = 12
# _C.TRAINER.HICROPL.TEACHER_NAME = "ViT-B/16"
# _C.TRAINER.HICROPL.LAMBD = 12.0
# _C.TRAINER.HICROPL.CTX_INIT_MODE = "default"
# _C.TRAINER.HICROPL.CTX_INIT_CLASSDEF_FILE = ""
# _C.TRAINER.HICROPL.CTX_INIT_BLEND = 1.0

# Segmentation Extras
_C.TRAINER.HICROPL_SEG = CN()
_C.TRAINER.HICROPL_SEG.PATCH_SIZE = 16
_C.TRAINER.HICROPL_SEG.ASPP_CHANNELS = 256
_C.TRAINER.HICROPL_SEG.ATROUS_RATES = (1, 2, 4)
_C.TRAINER.HICROPL_SEG.LOSS = "ce_dice"
_C.TRAINER.HICROPL_SEG.CE_WEIGHT = 1.0
_C.TRAINER.HICROPL_SEG.DICE_WEIGHT = 1.0
_C.TRAINER.HICROPL_SEG.DICE_EPS = 1e-6
_C.TRAINER.HICROPL_SEG.CLASS_WEIGHTS = ()
_C.TRAINER.HICROPL_SEG.USE_DESC = True
_C.TRAINER.HICROPL_SEG.DESC_W = 0.1
_C.TRAINER.HICROPL_SEG.DESC_BANK = "data/bing_rgb/desc_emb_bank.pt"
_C.TRAINER.HICROPL_SEG.USE_CLASS_DESC = True
_C.TRAINER.HICROPL_SEG.CLASS_DESC_ALPHA =  2.0
_C.TRAINER.HICROPL_SEG.USE_DESC_DIRECT = False
_C.TRAINER.HICROPL_SEG.DESC_DIRECT_ALPHA = 1.0
_C.TRAINER.HICROPL_SEG.DESC_DIRECT_HIDDEN = 256
# _C.TRAINER.HICROPL_SEG.USE_META = True
# # _C.TRAINER.HICROPL_SEG.META_W = 0.1
# _C.TRAINER.HICROPL_SEG.META_BANK = "data/bing_rgb/meta_num_bank.pt"
# _C.TRAINER.HICROPL_SEG.META_HIDDEN = 256

_C.TRAINER.HICROPL_SEG.USE_META_TEXT = True
_C.TRAINER.HICROPL_SEG.META_TEXT_BANK = "data/bing_rgb/meta_token_bank.pt"
_C.TRAINER.HICROPL_SEG.META_TEXT_ALPHA = 1.0
_C.TRAINER.HICROPL_SEG.META_TEXT_HIDDEN = 256

_C.TRAINER.HICROPL_SEG.DECODER = "deeplabv3"  # "deeplabv3" | "seg_linear" | "seg_mask"
_C.TRAINER.HICROPL_SEG.SEG_N_LAYERS = 2
_C.TRAINER.HICROPL_SEG.SEG_N_HEADS = 8
_C.TRAINER.HICROPL_SEG.SEG_D_MODEL = 256
_C.TRAINER.HICROPL_SEG.SEG_D_FF = 1024
_C.TRAINER.HICROPL_SEG.SEG_DROP_PATH = 0.0
_C.TRAINER.HICROPL_SEG.SEG_DROPOUT = 0.0
